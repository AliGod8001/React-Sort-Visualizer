...
const MainButton = ({
    ...
    type: "primary" | "primary-outline" | "primary-flat" | "secondary" | "secondary-outline" | "secondary-flat",
    className?: string,
    onClick?: () => void,
    disabled?: boolean,
}) => {
    const classes = `${styles.button} ${convertType(type)} ${className !== undefined ? className : ""}`
